      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav mr-auto">
          <li className="nav-item">
            <a className="nav-link" href="https://www.lloyds.com/about-lloyds">
          ...
          <li className="nav-item">
            <a className="nav-link" href="https://www.lloyds.com/policyholder">
              Policyholders
            </a>
          </li>
          <li className="nav-item">
            <a className="nav-link" href="https://www.lloyds.com/careers">
              Careers
            </a>
          </li>
          <li className="nav-item">
          ...
          <li className="nav-item">
            <a className="nav-link" href="https://www.lloyds.com/contact-us">
              Contact
            </a>
          </li>
          <li className="nav-item">
